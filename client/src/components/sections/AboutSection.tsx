              ...
              <div className="grid md:grid-cols-2 gap-12">
                ...
                <div className="space-y-6 text-gray-400 leading-relaxed">
                  <p>
                    ...
                    systems, where I focus on building scalable backend workflows
                    and clean, maintainable frontend applications.
                  </p>
                ...
                <div className="space-y-6">
                  ...
                  <InfoCard
                    ...
                    description={
                      "Built and optimized loan origination workflows, reducing manual effort by ~50% and improving system efficiency across multiple branches."
                    }
                  ></InfoCard>
                  ...
                  <InfoCard
                    title={"Tech Focus"}
                    description={
                      "React, Node.js, TypeScript, MongoDB, PostgreSQL, and AI integrations"
                    }
                  ></InfoCard>
                  ...
                  <InfoCard
                    title={"Interests"}
                    description={
                      "AI systems, automation, backend architecture, and developer tooling"
                    }
                  ></InfoCard>
                </div>
              </div>
